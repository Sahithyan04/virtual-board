...
cv2.rectangle(tools, (0,0), (max_x, max_y), (255,0,0), 2)
cv2.line(tools, (50,0), (50,50), (255,0,0), 2)
cv2.line(tools, (100,0), (100,50), (255,0,0), 2)
cv2.line(tools, (150,0), (150,50), (255,0,0), 2)
cv2.line(tools, (200,0), (200,50), (255,0,0), 2)
'''
...
while True:
	...
	cv2.setWindowProperty("paint app", cv2.WND_PROP_TOPMOST,1)
